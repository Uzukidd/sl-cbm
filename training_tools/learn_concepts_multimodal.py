...
if __name__ == "__main__":
    ...
    if args.classes == "cifar10":
        ...
        cifar10_ds = datasets.CIFAR10(root=args.dataset_path, train=True, download=True)
        # Get the class names.
        ...
        from torchvision import datasets
        cifar100_ds = datasets.CIFAR100(root=args.dataset_path, train=True, download=True)
