cd ../../..
python spmss_vl_cbm_train.py --backbone-name="open_clip:ViT-B-16" \
    ...
    --universal-seed="24" \
    --dataset="spss_rival10" \
    --exp-name="lambda_ablation/cspmss_vl_cbm_train_simple_concepts_$1_$2_$3_$4" \
    --loss="spss" \
