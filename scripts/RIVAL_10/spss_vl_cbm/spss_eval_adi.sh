...
python spss_vl_cbm_train.py --backbone-name="open_clip:ViT-B-16" \
    ...
    --pcbm-ckpt="outputs/lambda_ablation/spss_vl_cbm_train_simple_concepts_$1_$2_$3/trainable_weights.pt" \
    --universal-seed="24" \
    --exp-name="lambda_ablation/eval_spss_vl_cbm_train_simple_concepts_$1_$2_$3" \
    --not-save-ckpt \
